...
const ProfileCardComponent = ({
    ...
    const cardStyle = useMemo(
        () => ({
            ...
            '--sunpillar-1': 'hsl(217, 100%, 75%)',
            '--sunpillar-2': 'hsl(200, 100%, 70%)',
            '--sunpillar-3': 'hsl(220, 100%, 72%)',
            '--sunpillar-4': 'hsl(190, 100%, 76%)',
            '--sunpillar-5': 'hsl(230, 100%, 74%)',
            '--sunpillar-6': 'hsl(210, 100%, 73%)',
